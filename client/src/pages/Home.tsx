        ...
        <div className="container max-w-3xl mx-auto">
          ...
          <div className="relative">
            ...
            <blockquote className="text-lg text-white/80 leading-relaxed">
              Renolab was built by Darren Kearney â a joiner, carpenter, and tradesman from Northern Ireland with over a decade on real building sites. Every estimate, every material cost, and every labour rate in this platform comes from real project experience, not scraped data or UK-wide averages.
            </blockquote>
            <p className="mt-6 text-white/60 leading-relaxed">
              Renolab is not a tech company that discovered construction. It is a trade platform built by someone who has priced, planned, and delivered renovation projects across Northern Ireland â by someone who has priced a job at 9pm, sourced timber at 7am, and built things with his own hands. That is the difference.
            </p>
