...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-background font-[Inter,sans-serif]">
      <title>Plotrapp — Home. The Renovation Platform for the island of Ireland.</title>
      <NavBar />
      ...
      <section className="py-20 bg-muted/30">
        <div className="container max-w-5xl mx-auto">
          <h2 className="text-3xl font-extrabold text-center mb-4">Who is Plotrapp for?</h2>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-card border border-border rounded-2xl p-8 flex flex-col gap-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Planning a renovation or building new? Plotrapp helps you understand what a project involves, what materials you'll likely need, and how to buy them at better prices — without needing trade experience. Use the renovation wizard for existing rooms or the New Build mode for house plans.
              </p>
            </div>
            <div className="bg-card border border-border rounded-2xl p-8 flex flex-col gap-4">
              <div className="w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Pricing jobs takes time. Plotrapp speeds up the estimating process, generates materials lists from photos and measurements, and gives you a faster path from site visit to quote.
              </p>
            </div>
          </div>
      ...
      <section className="py-20 bg-background">
        <div className="container max-w-5xl mx-auto">
          <h2 className="text-3xl font-extrabold text-center mb-4">How Plotrapp works</h2>
            ...
            {[
              {
                ...
                desc: "Add room photos, measurements, and a few simple project choices so Plotrapp understands what you're trying to do.",
              },
              {
                icon: ListChecks,
                step: "2",
                title: "Get a guided estimate and shopping list",
                desc: "Plotrapp builds a project estimate and generates a materials list based on your inputs.",
              },
              {
                icon: ShoppingBag,
                step: "3",
                title: "Unlock supplier discounts",
                desc: "Use your Plotrapp membership to access partner supplier discounts and member-only deals at the counter.",
              },
            ].map((item) => (
      ...
      {/* ── What a Plotrapp estimate looks like ────────────────────────── */}
      <section className="py-20 bg-muted/30">
        <div className="container max-w-4xl mx-auto">
          <h2 className="text-3xl font-extrabold text-center mb-4">What a Plotrapp estimate looks like</h2>
          ...
          <div className="bg-white border border-border rounded-2xl shadow-sm overflow-hidden max-w-2xl mx-auto">
            ...
            <div className="bg-[#0f1c2e] text-white px-6 py-4 flex items-center justify-between">
              <div>
                <p className="font-bold text-sm">Plotrapp Estimate</p>
                <p className="text-white/60 text-xs mt-0.5">Bathroom Renovation — Mid-range</p>
              </div>
          ...
          <p className="text-center text-sm text-muted-foreground mt-6 max-w-xl mx-auto">
            This is the kind of output Plotrapp generates — an itemised materials list with real pricing, ready to take to any supplier.
          </p>
          <p className="text-center text-sm text-primary/80 mt-3 max-w-xl mx-auto font-medium">
            Pro members can also generate a full 3D project visualisation from these inputs — see exactly what your finished room will look like.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                No room photos yet — because the walls aren't up. Plotrapp's New Build mode lets you select your rooms, enter rough dimensions, choose a finish level, and get a full house fit-out estimate broken down room by room.
              </p>
      ...
      {/* ── Why Plotrapp exists — Founder story ────────────────────────── */}
      <section className="py-20 bg-[#0f1c2e] text-white">
        <div className="container max-w-3xl mx-auto">
          <h2 className="text-3xl font-extrabold text-center mb-10">Why Plotrapp exists.</h2>
          <div className="relative">
            <Quote className="w-10 h-10 text-primary/40 mb-4" />
            <blockquote className="text-lg text-white/80 leading-relaxed">
              Plotrapp was built by Darren Kearney — a joiner, carpenter, and tradesman from the island of Ireland who spent years watching homeowners get ripped off and tradespeople waste hours on admin that should take minutes. After a career in joinery, fitted furniture, kitchens, and construction, Darren built Plotrapp to solve the problems he lived every day on site.
            </blockquote>
            <p className="mt-6 text-white/60 leading-relaxed">
              Plotrapp is not a tech company that discovered construction. It is a trade platform built from the inside out — by someone who has priced a job at 9pm, sourced timber at 7am, and built things with his own hands. That is the difference.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container max-w-5xl mx-auto">
          <h2 className="text-3xl font-extrabold text-center mb-12">Why people use Plotrapp</h2>
          <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
            {[
              ...
              { icon: Camera, title: "Visualise every room before you buy a single tile", desc: "Generate a 3D visualisation of your finished room before you spend a penny. See exactly what your choices look like — walls, floors, fittings — all rendered from your project inputs." },
            ].map((item) => (
        ...
        <div className="container max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-card border border-border rounded-2xl p-8 flex flex-col">
              ...
              <p className="text-muted-foreground text-sm mb-4">Perfect for trying Plotrapp out</p>
            ...
            <div className="bg-card border border-border rounded-2xl p-8 flex flex-col">
              ...
              <ul className="space-y-2.5 flex-1 mb-8">
                {["Everything in Pro", "Faster workflow", "More saved projects", "Labour and margin options", "Reusable project templates", "Trade-focused supplier deals", "Unlimited visualisations — save to client project folders"].map(f => (
                  <li key={f} className="flex items-start gap-2 text-sm">
                    <CheckCircle className="w-4 h-4 text-primary mt-0.5 shrink-0" />
                    <span>{f}</span>
                  </li>
      ...
      <section className="py-20 bg-[#0f1c2e] text-white">
        <div className="container max-w-3xl mx-auto text-center">
          ...
          <p className="text-white/70 text-lg mb-4 leading-relaxed">
            Plotrapp is not just an estimating tool.<br />It helps you turn a project into a buying plan.
          </p>
      ...
      <section className="py-20 bg-primary text-white">
        <div className="container max-w-3xl mx-auto text-center">
          ...
          <p className="text-white/80 text-lg mb-10 leading-relaxed max-w-2xl mx-auto">
            Whether you're renovating your own home or pricing work for a customer, Plotrapp helps you plan faster and buy smarter.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/estimate">
      ...
      <footer className="bg-[#0a1520] text-white/40 py-10 text-center text-sm border-t border-white/5">
        <div className="flex items-center justify-center gap-2 mb-3">
          ...
          <span className="font-semibold text-white/60">Plotrapp</span>
        </div>
        <p className="mb-1">Smart planning tools. Guided estimates. Supplier discounts.</p>
        <p>For homeowners and tradespeople.</p>
        <p className="mt-2 font-semibold text-white/60">Built on the island of Ireland. plotrapp.co.uk</p>
        ...
        <p className="mt-6 text-white/20">© {new Date().getFullYear()} Plotrapp. All rights reserved.</p>
      </footer>
    </div>
  );
}
