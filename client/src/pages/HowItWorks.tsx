            ...
            <div className="bg-card border border-border rounded-2xl p-8">
              ...
              <ul className="space-y-2">
                {[
                  ...
                  "Full materials list with quantities and supplier pricing guidance",
          ...
          <div className="grid md:grid-cols-2 gap-16">
            ...
            <div>
              ...
              <Step
                ...
                description="Renolab generates a cost range and itemised materials list in seconds. You'll see exactly what materials you likely need, in what quantities, and with realistic supplier pricing guidance  -  before you've spoken to a single supplier."
              />
              <Step
                number={5}
                icon={Sparkles}
              ...
              <Step
                number={6}
                icon={ShoppingBag}
                title="Buy with clearer supplier guidance"
                description="Use your materials list to compare options with local supplier guidance. Member-only offers can be shown when supplier partnerships are active."
              />
              <div className="mt-2">
                <Link href="/estimate">
        ...
        <div className="container max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-x-12">
            <div>
              ...
              <FeatureRow
                icon={ShoppingBag}
                title="Supplier guidance, not guesswork"
                desc="Renolab is being built around local supplier relationships, giving members clearer pricing guidance and practical buying options without exposing private supplier costs."
              />
            </div>
            <div>
              <FeatureRow
