        ...
        {!isProUser && (
          <>
            <div className="flex items-center gap-3 my-6">
              ...
              <span className="text-slate-400 text-sm font-medium">Unlock with Pro</span>
              <div className="flex-1 h-px bg-slate-700" />
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
              <LockedCard
                ...
                description="Itemised shopping list with quantities, trade prices, and supplier links."
              />
              <LockedCard
                icon={Ruler}
                title="Detailed Measurements"
                description="Full breakdown of floor area, wall area, perimeter, and room features."
              />
              <LockedCard
                icon={FileText}
                title="PDF Export"
                description="Download a branded PDF quote to share with contractors or keep for records."
              />
              <LockedCard
                icon={Tag}
                title="Supplier Discount Access"
                description="Direct links to trade-priced materials from our supplier network."
              />
            </div>

            {/* Upgrade CTA */}
            <div className="bg-gradient-to-br from-[#FF6B2C]/10 to-[#1E293B] border border-[#FF6B2C]/30 rounded-2xl p-8 text-center mb-8">
              <h2 className="text-2xl font-bold mb-2">Get the full picture</h2>
              <p className="text-slate-400 mb-6 max-w-sm mx-auto">
                Upgrade to Pro for the complete materials list, PDF export, and supplier discount access — from £9.99/month.
              </p>
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                ...
                >
                  Upgrade to Pro — £9.99/mo <ChevronRight className="w-4 h-4 ml-1" />
                </Button>
                {!user && (
                  <Button
                    variant="outline"
