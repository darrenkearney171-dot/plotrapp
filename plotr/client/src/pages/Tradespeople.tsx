...
export default function Tradespeople() {
  ...
  return (
    <div className="min-h-screen bg-background font-[Inter,sans-serif]">
      <title>Plotrapp — Tradespeople. The Renovation Platform for the island of Ireland.</title>
      <NavBar />
      ...
      <main className="container py-10">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground text-sm">Vetted tradespeople across the island of Ireland. All verified by Plotrapp.</p>
        </div>
            ...
            {filtered.map(person => (
              <div key={person.id} className="bg-card border border-border rounded-xl p-6 flex flex-col gap-4 hover:shadow-md transition-shadow">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      ...
                      {person.isVerified && (
                        <CheckCircle className="w-4 h-4 text-primary shrink-0" aria-label="Verified by Plotrapp" />
                      )}
                    </div>
                ...
                <div className="mt-auto pt-2 border-t border-border flex flex-col gap-1.5">
                  <Button size="sm" className="w-full bg-primary hover:bg-primary/90 text-white font-semibold" onClick={() => toast.info("Request Introduction will be available at launch.")}>
                    Request Introduction
                  </Button>
                  <p className="text-xs text-muted-foreground text-center">Available at launch.</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <section className="mt-20 bg-[#0f1c2e] text-white rounded-2xl p-10">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-white/70 mb-8 leading-relaxed">
              Get listed on Plotrapp and receive verified job leads from homeowners in your area. Free to apply during our founding launch period.
            </p>
            ...
            {appSubmitted ? (
              ...
              <form onSubmit={handleApplicationSubmit} className="grid sm:grid-cols-2 gap-4">
                ...
                <div className="sm:col-span-2">
                  ...
                  >
                    {submitApplication.isPending ? "Submitting…" : "Apply to join Plotrapp"}
                  </Button>
                </div>
              </form>
            )}
